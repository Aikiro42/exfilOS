...
class FileSystem:
  ...
  @staticmethod
  def from_json(json: dict) -> FileSystem | None:
    """
    Returns a FileSystem object from a deserialized JSON object. If an error is encountered, returns `None`.
    
    The JSON object must have the following structure:
    ```
    {
      "capacity": int,
      "root": [list of File JSONs]
    }
    ```
    In essence, the passed dict should be something that can be generated by `FileSystem.to_json()`.
    """
