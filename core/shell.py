...
class Mollusk:
  ...
  def savegame(self, cmd: Command, exiting:bool=False, forceExit:bool=False, savepath:str | None = None) -> bool:
    if savepath is None:
      savepath = f"savedata/{self.user.name}/filesys.json"
    return self.home.save(savepath)
    ...
